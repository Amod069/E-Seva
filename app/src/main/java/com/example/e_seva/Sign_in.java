...
public class Sign_in extends AppCompatActivity implements View.OnClickListener {
    ...
    EditText  emailtxt, passwordtxt;
            TextView forgotpassword,signuptxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(firebaseUser != null && firebaseUser.isEmailVerified()){
            ...
            Intent intent = new Intent(Sign_in.this,home_screenn.class);
                                ...
                                if (task.isSuccessful()) {
                                   firebaseUser = firebaseAuth.getInstance().getCurrentUser();
                                    if(firebaseUser.isEmailVerified()) {
                                        ...
                                        intenthome.putExtra("username", txt_email);
                                        intenthome.addFlags(intenthome.FLAG_ACTIVITY_CLEAR_TOP);
                                        intenthome.addFlags(intenthome.FLAG_ACTIVITY_NEW_TASK);
    ...
    private void updateUI(FirebaseUser fUser) {
        ...
        if (account != null) {
            ...
            Intent intent1 = new Intent(this,home_screenn.class);
            intent1.putExtra("username",mail);
            Toast.makeText(Sign_in.this, "welcome" +mail, Toast.LENGTH_SHORT).show();
        }
    }
